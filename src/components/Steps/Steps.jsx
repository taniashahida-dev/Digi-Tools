        ...
        <div className='bg-gray-100 my-20'>
          <div className='w-10/12 mx-auto text-center py-10 ' >
              <div className=' space-y-2 mt-20'>
                ...
                <p className='text-gray-400 text-xl mt-3'>Start using premium digital tools in minutes, not hours.</p>
            </div>
            <div className='grid grid-cols-2 lg:grid-cols-3 gap-10  my-20'>
